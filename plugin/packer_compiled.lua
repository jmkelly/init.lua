...
_G.packer_plugins = {
  ...
  ["cmp-nuget"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/cmp-nuget",
    url = "https://github.com/PasiBergman/cmp-nuget"
  },
  ["cmp-nvim-lsp"] = {
    loaded = true,
  ...
  ["pears.nvim"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/pears.nvim",
